...
<div class="page-header">
   ...
   $qry="select hallid,register_date,start_date,end_date,start_time,end_time,notes,persons,dop,ispay,member.fname as fname,member.lname as lname from banquet_hallbooking,member where banquet_hallbooking.mid='$memid' and banquet_hallbooking.mid=member.mid" ;
   ...
   $str.="<tr> <td>$register_date</td><td>$fname $lname</td><td>$dos</td><td>$doe</td><td>$tos</td><td>$toe</td><td>$reason</td><td>$persons</td><td>$dop</td>";
   if($ispay=='No'){
